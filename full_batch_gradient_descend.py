...
for current_index in range(epochs):
    ...
    average_grad_w0 = (2 / dataset_len) * grad_w0_total
    average_grad_w1 = (2 / dataset_len) * grad_w1_total
    average_grad_w2 = (2 / dataset_len) * grad_w2_total

    w0 = w0 - (learning_rate * average_grad_w0)
    w1 = w1 - (learning_rate * average_grad_w1)
    w2 = w2 - (learning_rate * average_grad_w2)
